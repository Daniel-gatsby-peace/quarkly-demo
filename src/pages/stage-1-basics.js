			...
			<Box display="flex" width="100%" md-flex-direction="column">
				...
				>
					...
					<Box
						...
						text-align="left"
						display="flex"
						sm-background="rgba(237, 242, 246, 0) repeating-linear-gradient(-45deg,--color-light 0px,--color-light 5px,rgba(0,0,0,0) 5px,rgba(0,0,0,0) 10px) center center space"
					>
						<Box sm-height="320px" sm-width="100%" sm-background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?fit=crop&w=750&q=80) 0% 0% /auto repeat scroll padding-box">
							<Icon category="md" icon={MdFace} size="64зч" />
							<Text>
								Into the Wild
							</Text>
					...
					>
						<Box width="100%" background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30) 50% 50%/cover" border-radius="12px" height="320px">
							...
							<Text
								...
								color="--light"
								text-align="center"
								sm-font="normal 500 28px/1.2 --fontFamily-googleOpenSansCondensed"
							>
								Into the Wild
							</Text>
							<Text font="--base" color="--lightD2" text-align="center">
		...
		<Section padding="100px 0" sm-padding="40px 0" md-padding="60px 0 60px 0" quarkly-title="Step 5. Change the Icon">
			...
			<Box display="flex" width="100%" md-flex-direction="column">
				...
				>
					...
					>
						<Box width="100%" background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30) 50% 50%/cover" border-radius="12px" height="320px">
							<Icon category="fa" icon={FaTree} sm-color="#ffffff" sm-font="44px sans-serif" />
							<Text font="normal 500 28px/1.2 --fontFamily-googleRobotoCondensed" text-transform="uppercase" color="--light" text-align="center">
								Into the Wild
							</Text>
							<Text font="--base" color="--lightD2" text-align="center">
				...
				>
					...
					>
						<Box
							...
							align-items="center"
							justify-content="center"
							sm-padding="48px 36px 72px 36px"
							sm-margin="0px 0px 0px 0px"
						>
							<Icon category="fa" icon={FaTree} font="44px sans-serif" color="--light" />
							<Text font="normal 500 28px/1.2 --fontFamily-googleRobotoCondensed" text-transform="uppercase" color="--light" text-align="center">
					...
					>
						...
						>
							<Icon
								category="fa"
								icon={FaTree}
								sm-font="64px sans-serif"
								sm-color="--red"
								sm-margin="0px 0px 12px 0px"
							/>
							<Text sm-font="--headline3" sm-color="--darkL2" sm-text-align="center" sm-margin="24px 0px 0px 0px">
								Woods & Mountains
							</Text>
							<Text sm-font="--base" sm-color="--grey" sm-margin="16px 0px 0px 0px">
								43 places
							</Text>
						</Box>
					</Box>

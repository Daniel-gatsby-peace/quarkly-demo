				...
				>
					...
					>
						<Box
							...
							opacity="1"
							sm-background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30) center/cover"
							sm-hover-background="rgba(0, 0, 0, 0) url(https://images.unsplash.com/photo-1593431074633-21ef64707d29?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&ixid=eyJhcHBfaWQiOjE0MjIzN30) 100% 0%/100%"
						>
				...
				>
					...
					>
						<Box
							...
							padding="48px 36px 72px 36px"
							opacity="1"
							sm-transition="background 0.3s ease 0s"
						>
							<Icon category="fa" icon={FaTree} font="44px sans-serif" color="--light" />
							<Text
								font="--headline3"

...
You can convert only one element, but that element can contain other elements.
				...
				>
					...
					>
						<Components.TreeCard />
						<Components.TreeCard>
							<Override slot="text1" sm-color="--primary" />
						</Components.TreeCard>
					</Box>
					<Text
						text-align="center"
			...
			<Box display="flex" flex-direction="column" width="100%">
				...
				>
					...
					>
						...
						<Components.CardWorkStep2 border-radius="36px" lg-margin="0px 32px 32px 0px" margin="0px 32px 0px 0px">
							<Override slot="text" />
							<Override slot="text1">
								A wonderful journey into the woods and mountains that will heal your mind, body, and soul. It’ll be a trip to remember
							</Override>
					...
					>
						<Components.CardExampleStep2 margin="0px 32px 0px 0px" lg-margin="0px 32px 32px 0px">
							...
							<Override slot="button" sm-background="--color-orange">
								JOIN
							</Override>
			...
			<Box display="flex" flex-direction="column" width="100%">
				...
				>
					...
					>
						...
						>
							<Icon category="fa" icon={FaTree} color="--light" font="32px sans-serif" />
							<Text
								text-transform="uppercase"
								color="--light"
								text-align="left"
